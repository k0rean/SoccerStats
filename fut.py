...
class Application:
	def __init__(self, master=None):
		...
		self.fouls.place(x=x_buttons_stats, y=9*N)
		## Shots_acc
		...
		self.cards.place(x=x_buttons_stats, y=10*N)
		...
		self.liganos.place(x=x_buttons_league, y=8*N)
		## premier_league
		...
		self.premier_league.place(x=x_buttons_league, y=3*N)
		## championship
		...
		self.championship.place(x=x_buttons_league+150	, y=3*N)
		## La_Liga
		...
		self.La_Liga.place(x=x_buttons_league, y=4*N)
		## La_Liga2
		...
		self.La_Liga2.place(x=x_buttons_league+150, y=4*N)
		## SerieA
		...
		self.SerieA.place(x=x_buttons_league, y=5*N)
		## SerieB
		...
		self.SerieB.place(x=x_buttons_league+150, y=5*N)
		## Bundesliga
		...
		self.Bundesliga.place(x=x_buttons_league, y=6*N)
		## Bundesliga2
		...
		self.Bundesliga2.place(x=x_buttons_league+150, y=6*N)
		## Ligue 1
		...
		self.ligue1.place(x=x_buttons_league, y=7*N)
		## Ligue 2
		...
		self.ligue2.place(x=x_buttons_league+150, y=7*N)
		## Jupiler
		self.ligue1 = Button(self.widget1)
		...
		self.ligue1.place(x=x_buttons_league, y=9*N)
		## Eredivisie
		self.ligue1 = Button(self.widget1)
		...
		self.ligue1.place(x=x_buttons_league, y=10*N)
		## Greece
		self.ligue1 = Button(self.widget1)
		...
		self.ligue1.place(x=x_buttons_league, y=11*N)
		## Turkey
		self.ligue1 = ttk.Button(self.widget1)
		self.ligue1["text"] = "Turkey"
		self.ligue1["font"] = ("Calibri", "11")
		self.ligue1["width"] = 14
		self.ligue1.bind("<Button-1>", self.turkey_func)
		self.ligue1.place(x=x_buttons_league, y=12*N)
		## Turkey
		self.ligue1 = Button(self.widget1)
		self.ligue1["text"] = "Premiership"
		self.ligue1["font"] = ("Calibri", "11")
		self.ligue1["width"] = 14
		self.ligue1.bind("<Button-1>", self.premiership_func)
		self.ligue1.place(x=x_buttons_league, y=13*N)
		## EXIT
		...
		self.ligue1.place(x=x_buttons_league, y=16*N)
